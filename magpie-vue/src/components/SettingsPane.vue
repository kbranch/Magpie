    ...
    <div class="offcanvas-body">
        ...
        <div class="row">
                ...
                <fieldset class="form-group">
                    ...
                    <div class="row pb-3">
                        <div class="col">
                            ...
                            <label class="form-check-label" for="arg-ap_logic"><img class="settings-image" src="/images/archipelago.png">Archipelago logic mode</label>
                        </div>
                    </div>
                </fieldset>
            <!-- </div>
                ...
                <fieldset class="form-group">
                    ...
                    <div class="row pb-3">
                        <div class="col">
                            ...
                            <label class="form-check-label" for="arg-heartpiece"><img class="settings-image" src="/images/HEART_PIECE_1.png">Randomize heart pieces</label>
                        </div>
                    </div>
                    <div class="row pb-3">
                        <div class="col">
                            <input type="checkbox" id="arg-seashells" class="form-check-input" data-flag="seashells">
                            <label class="form-check-label" for="arg-seashells"><img class="settings-image" src="/images/SEASHELL_1.png">Randomize hidden seashells</label>
                        </div>
                    </div>
                    <div class="row pb-3">
                        <div class="col">
                            <input type="checkbox" id="arg-heartcontainers" class="form-check-input" data-flag="heartcontainers">
                            <label class="form-check-label" for="arg-heartcontainers"><img class="settings-image" src="/images/HEART_CONTAINER_1.png">Randomize heart containers</label>
                        </div>
                    </div>
                    <div class="row pb-3">
                        <div class="col">
                            <input type="checkbox" id="arg-instruments" class="form-check-input" data-flag="instruments">
                            <label class="form-check-label" for="arg-instruments"><img class="settings-image" src="/images/INSTRUMENT1_1.png">Randomize instruments</label>
                        </div>
                    </div>
                    <div class="row pb-3">
                        <div class="col">
                            <input type="checkbox" id="arg-tradequest" class="form-check-input" data-flag="tradequest">
                            <label class="form-check-label" for="arg-tradequest"><img class="settings-image" src="/images/TRADING_ITEM_YOSHI_DOLL_1.png">Randomize trade quest</label>
                        </div>
                    </div>
                    <div class="row pb-3">
                        <div class="col">
                            <input type="checkbox" id="arg-witch" class="form-check-input" data-flag="witch">
                            <label class="form-check-label" for="arg-witch"><img class="settings-image" src="/images/TOADSTOOL_1.png">Randomize item given by the witch</label>
                        </div>
                    </div>
                    <div class="row pb-3">
                        <div class="col">
                            <input type="checkbox" id="arg-rooster" class="form-check-input" data-flag="rooster">
                            <label class="form-check-label" for="arg-rooster"><img class="settings-image" src="/images/ROOSTER_1.png">Add the rooster</label>
                        </div>
                    </div>
                </fieldset>
            </div>
            <div class="col-auto">
                <fieldset class="form-group">
                    ...
                    <div class="row pb-3">
                        <div class="col">
                            <label for="arg-dungeon_items" class="form-label"><img class="settings-image" src="/images/KEY1_1.png">Dungeon items</label>
                            ...
                            <div id="customDungeonItems" class="pt-2">
                                <div class="row">
                                    <div class="col-4 text-center">
                                        ...
                                        <label class="form-check-label" for="arg-shuffle_maps"><img class="settings-image" src="/images/MAP1_1.png"></label>
                                    </div>
                                    <div class="col-4 text-center">
                                        <input type="checkbox" id="arg-shuffle_compasses" class="form-check-input" data-flag="shuffle_compasses">
                                        <label class="form-check-label" for="arg-shuffle_compasses"><img class="settings-image" src="/images/COMPASS1_1.png"></label>
                                    </div>
                                    <div class="col-4 text-center">
                                        <input type="checkbox" id="arg-shuffle_beaks" class="form-check-input" data-flag="shuffle_beaks">
                                        <label class="form-check-label" for="arg-shuffle_beaks"><img class="settings-image" src="/images/STONE_BEAK1_1.png"></label>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col"></div>
                                    <div class="col-4 text-center">
                                        ...
                                        <label class="form-check-label" for="arg-shuffle_small"><img class="settings-image" src="/images/KEY1_1.png"></label>
                                    </div>
                                    <div class="col-4 text-center">
                                        <input type="checkbox" id="arg-shuffle_nightmare" class="form-check-input" data-flag="shuffle_nightmare">
                                        <label class="form-check-label" for="arg-shuffle_nightmare"><img class="settings-image" src="/images/NIGHTMARE_KEY1_1.png"></label>
                                    </div>
                                    <div class="col"></div>
                                </div>
                            </div>
                    ...
                    <div class="row pb-3">
                        <div class="col">
                            <label for="arg-boss" class="form-label"><img class="settings-image" src="/images/b8.png">Boss shuffle</label>
                    ...
                    <div class="row pb-3">
                        <div class="col">
                            <label for="arg-miniboss" class="form-label"><img class="settings-image" src="/images/m1.png">Miniboss shuffle</label>
            ...
            <div class="col-auto">
                <fieldset class="form-group">
                    ...
                    <div class="row pb-3">
                        <div class="col">
                            <label for="arg-entranceshuffle" class="form-label"><img class="settings-image" src="/images/entrance.svg">Entrance randomizer</label>
                    ...
                    <div class="row pb-3">
                        <div class="col">
                            ...
                            <label class="form-check-label" for="arg-randomstartlocation"><img class="settings-image" src="/images/marin.png">Random start location</label>
                        </div>
                    </div>
                    <div class="row pb-3">
                        <div class="col">
                            <input type="checkbox" id="arg-dungeonshuffle" class="form-check-input" data-flag="dungeonshuffle">
                            <label class="form-check-label" for="arg-dungeonshuffle"><img class="settings-image" src="/images/NIGHTMARE_KEY1_1.png">Dungeon shuffle</label>
                        </div>
                    </div>
                    <div class="row pb-3">
                        <div class="col">
                            <input type="checkbox" id="arg-shufflejunk" class="form-check-input" data-flag="shufflejunk">
                            <label class="form-check-label" for="arg-shufflejunk"><img class="settings-image" src="/images/phonebooth.png">Shuffle itemless entrances</label>
                        </div>
                    </div>
                    <div class="row pb-3">
                        <div class="col">
                            <input type="checkbox" id="arg-shuffleannoying" class="form-check-input" data-flag="shuffleannoying">
                            <label class="form-check-label" for="arg-shuffleannoying"><img class="settings-image" src="/images/mamu.png">Shuffle annoying entrances</label>
                        </div>
                    </div>
                    <div class="row pb-3">
                        <div class="col">
                            <input type="checkbox" id="arg-shufflewater" class="form-check-input" data-flag="shufflewater">
                            <label class="form-check-label" for="arg-shufflewater"><img class="settings-image" src="/images/manbo.png">Shuffle water entrances</label>
                        </div>
                    </div>
                </fieldset>
            </div>
            <div class="col-auto">
                <fieldset class="form-group">
                    ...
                    <div class="row pb-3">
                        <div class="col">
                            <label for="arg-bowwow" class="form-label"><img class="settings-image" src="/images/BOWWOW_1.png">Good boy mode</label>
                    ...
                    <div class="row pb-3">
                        <div class="col">
                            <label for="arg-overworld" class="form-label"><img class="settings-image" src="/images/grass.png">Overworld</label>
                    ...
                    <div class="row pb-3">
                        <div class="col">
                            <label for="arg-owlstatues" class="form-label"><img class="settings-image" src="/images/owlstatue.png">Owl statues</label>
        ...
        <div class="row">
                ...
                <fieldset class="form-group">
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <label for="showHigherLogic" class="form-label"><img src="/images/higher-logic.svg" class="tooltip-check-graphic align-middle">Show higher logic levels</label>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col">
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <label for="showVanillaEntrances" class="form-label" data-bs-toggle="tooltip" data-bs-title="Show vanilla entrances and dungeon stairs"><img class="tooltip-check-graphic align-middle" src="/images/vanilla-entrance.svg">Show vanilla entrances</label>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col">
                            <input id="showLogicHints" data-setting="showLogicHints" type="checkbox" class="form-check-input">
                            <label for="showLogicHints" class="form-label" data-bs-toggle="tooltip" data-bs-title="Show logic hints"><img class="tooltip-check-graphic align-middle" src="/images/logicHints.svg">Show logic hints</label>
                        </div>
                    </div>
                </fieldset>
            </div>
            <div class="col-auto">
                <fieldset class="form-group pb-2">
                    ...
                    <div class="row">
                        <div class="col">
                            <label for="autotrackerAddressSetting" class="form-label">Server <img class="invert" src="/images/question-circle.svg" data-bs-toggle="tooltip" data-bs-custom-class="secondary-tooltip" data-bs-title="Address of the device that the autotracker is running on. Hostname or IP only, no port. The autotracker listens on port 17026. Note that modern browsers will typically block insecure connections to remote addresses. Either download the offline version of Magpie or configure your browser to allow insecure WebSocket connections."></label>
                ...
                <fieldset class="form-group">
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <label for="autotrackSpoilers" class="form-label">Track spoilers <img class="invert" src="/images/question-circle.svg" data-bs-toggle="tooltip" data-bs-custom-class="secondary-tooltip" data-bs-title="Loads a spoiler log from the ROM but does not spoil anything until asked"></label>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col">
                    ...
                    <div class="row">
                        <div class="col">
                            <label for="followToUnderworld" class="form-label">Map follows to underworld <img class="invert" src="/images/question-circle.svg" data-bs-toggle="tooltip" data-bs-custom-class="secondary-tooltip" data-bs-title="'Advanced ER' means that the map will only automatically switch to the underworld when the entrance randomizer setting is set to Wild or higher"></label>
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <label for="linkFaceSetting" class="form-label"> <img src="/images/linkface.png"></label>
                        </div>
                    </div>
                </fieldset>
            </div>
        ...
        <template v-if="local">
            ...
            <div class="row">
                <div class="col-auto">
                    <fieldset class="form-group pb-2">
                        <legend>Non-browser broadcast view</legend>
                        <div class="row">
                            <div class="col">
                                <label for="broadcastItems" class="form-label">Items</label>
                                <select id="broadcastItems" class="form-select" data-setting="broadcastItems" aria-label="broadcastItems">
                        ...
                        <div class="row pt-2">
                            <div class="col">
                                <label for="broadcastMap" class="form-label">Map</label>
                                <select id="broadcastMap" class="form-select" data-setting="broadcastMap" aria-label="broadcastMap">
                                    <option value="none">None</option>
                                    <option value="native">Native window</option>
                                    <option value="ndi">NDI</option>
                                </select>
                        ...
                        <div class="row pt-2">
                            <div class="col">
                                <div class="color-block">
                                    <label for='nativeBg' class="color-label">Native window background</label>
                                    <input class="color-picker" type="color" id="nativeBg" data-setting="nativeBgColor">
                                </div>
                            </div>
                        </div>
                    </fieldset>
                ...
                <div class="col-auto">
                    <fieldset class="form-group pb-2">
                        <div class="row">
                            <div class="col">
                                <h6>Also try these as browser sources or window captures in OBS:</h6>
                                <p class="mb-1">Items: <a href="/itemsBroadcast" class="href-content">{{ url_for('itemsBroadcast', _external=True) }}</a></p>
                                <p>Map: <a href="/mapBroadcast" class="href-content">{{ url_for('mapBroadcast', _external=True) }}</a></p>
                            </div>
                        </div>
                    </fieldset>
                </div>
        ...
        <div class="row">
            ...
            <div class="col col-auto mx-2">
                    ...
                    <p class="py-0 my-0"><a href="https://raw.githubusercontent.com/kbranch/Magpie/master/templates/mainitems/sevenbysix.html" target="_blank">Default main items template</a></p>
                    <p class="py-0 my-0"><a href="https://raw.githubusercontent.com/kbranch/Magpie/master/templates/dungeonitems/default.html" target="_blank">Default dungeon items template</a></p>
                    <p class="py-0 my-0"><a href="https://github.com/kbranch/Magpie/blob/master/CustomItemLayouts.md" target="_blank">Layout documentation</a></p>
            </div>
        </div>
        <div class="row pt-2">
            <div class="col-auto">
        ...
        <div class="row">
            <div class="col col-auto">
                <div class="color-block">
                    ...
                    <input class="color-picker" type="color" id="diff0" data-setting="diff0Color" data-bs-toggle="tooltip" data-bs-title="In logic" data-bs-trigger="hover">

                    <div class="opacity-block ps-2" data-bs-toggle="tooltip" data-bs-title="Opacity" data-bs-trigger="hover">
                        <label for='diff0Alpha' class="color-label"><img class="invert" src="/images/eye.svg"></label>
            ...
            <div class="col col-auto">
                <div class="color-block">
                    ...
                    <input class="color-picker" type="color" id="diff0V" data-setting="diff0VColor" data-bs-toggle="tooltip" data-bs-title="In logic, vanilla" data-bs-trigger="hover">

                    <div class="opacity-block ps-2" data-bs-toggle="tooltip" data-bs-title="Opacity" data-bs-trigger="hover">
                        <label for='diff0VAlpha' class="color-label"><img class="invert" src="/images/eye.svg"></label>
            ...
            <div class="col col-auto">
                <div class="color-block">
                    ...
                    <input class="color-picker" type="color" id="diff1" data-setting="diff1Color" data-bs-toggle="tooltip" data-bs-title="+1 difficulty" data-bs-trigger="hover">

                    <div class="opacity-block ps-2" data-bs-toggle="tooltip" data-bs-title="Opacity" data-bs-trigger="hover">
                        <label for='diff1Alpha' class="color-label"><img class="invert" src="/images/eye.svg"></label>
            ...
            <div class="col col-auto">
                <div class="color-block">
                    ...
                    <input class="color-picker" type="color" id="diff1V" data-setting="diff1VColor" data-bs-toggle="tooltip" data-bs-title="+1 difficulty, vanilla" data-bs-trigger="hover">

                    <div class="opacity-block ps-2" data-bs-toggle="tooltip" data-bs-title="Opacity" data-bs-trigger="hover">
                        <label for='diff1VAlpha' class="color-label"><img class="invert" src="/images/eye.svg"></label>
        ...
        <div class="row">
            <div class="col col-auto">
                <div class="color-block">
                    ...
                    <input class="color-picker" type="color" id="diff2" data-setting="diff2Color" data-bs-toggle="tooltip" data-bs-title="+2 difficulty" data-bs-trigger="hover">

                    <div class="opacity-block ps-2" data-bs-toggle="tooltip" data-bs-title="Opacity" data-bs-trigger="hover">
                        <label for='diff2Alpha' class="color-label"><img class="invert" src="/images/eye.svg"></label>
            ...
            <div class="col col-auto">
                <div class="color-block">
                    ...
                    <input class="color-picker" type="color" id="diff2V" data-setting="diff2VColor" data-bs-toggle="tooltip" data-bs-title="+2 difficulty, vanilla" data-bs-trigger="hover">

                    <div class="opacity-block ps-2" data-bs-toggle="tooltip" data-bs-title="Opacity" data-bs-trigger="hover">
                        <label for='diff2VAlpha' class="color-label"><img class="invert" src="/images/eye.svg"></label>
            ...
            <div class="col col-auto">
                <div class="color-block">
                    ...
                    <input class="color-picker" type="color" id="diff3" data-setting="diff3Color" data-bs-toggle="tooltip" data-bs-title="+3, +4 difficulty" data-bs-trigger="hover">

                    <div class="opacity-block ps-2" data-bs-toggle="tooltip" data-bs-title="Opacity" data-bs-trigger="hover">
                        <label for='diff3Alpha' class="color-label"><img class="invert" src="/images/eye.svg"></label>
            ...
            <div class="col col-auto">
                <div class="color-block">
                    ...
                    <input class="color-picker" type="color" id="diff3V" data-setting="diff3VColor" data-bs-toggle="tooltip" data-bs-title="+3, +4 difficulty, vanilla" data-bs-trigger="hover">

                    <div class="opacity-block ps-2" data-bs-toggle="tooltip" data-bs-title="Opacity" data-bs-trigger="hover">
                        <label for='diff3VAlpha' class="color-label"><img class="invert" src="/images/eye.svg"></label>
        ...
        <div class="row">
            ...
            <div class="col col-auto">
                <div class="color-block">
                    ...
                    <input class="color-picker" type="color" id="diff9" data-setting="diff9Color" data-bs-toggle="tooltip" data-bs-title="Out of logic" data-bs-trigger="hover">

                    <div class="opacity-block ps-2" data-bs-toggle="tooltip" data-bs-title="Opacity" data-bs-trigger="hover">
                        <label for='diff9Alpha' class="color-label"><img class="invert" src="/images/eye.svg"></label>
            ...
            <div class="col col-auto">
                <div class="color-block">
                    ...
                    <input class="color-picker" type="color" id="diff9V" data-setting="diff9VColor" data-bs-toggle="tooltip" data-bs-title="Out of logic, vanilla" data-bs-trigger="hover">

                    <div class="opacity-block ps-2" data-bs-toggle="tooltip" data-bs-title="Opacity" data-bs-trigger="hover">
                        <label for='diff9VAlpha' class="color-label"><img class="invert" src="/images/eye.svg"></label>
            ...
            <div class="col col-auto">
                <div class="color-block">
                    ...
                    <input class="color-picker" type="color" id="diffChecked" data-setting="diffCheckedColor" data-bs-toggle="tooltip" data-bs-title="Checked" data-bs-trigger="hover">

                    <div class="opacity-block ps-2" data-bs-toggle="tooltip" data-bs-title="Opacity" data-bs-trigger="hover">
                        <label for='diffCheckedAlpha' class="color-label"><img class="invert" src="/images/eye.svg"></label>
        ...
        <div class="row">
            <div class="col col-auto">
                ...
                <input class="color-picker" type="color" id="bgColor" data-setting="bgColor">
            </div>
            <div class="col col-auto">
                <label for='textColor' class="color-label">Text Color</label>
                <input class="color-picker" type="color" id="textColor" data-setting="textColor">
            </div>
            <div class="col col-auto">
                <label for='highlightColor' class="color-label">Item Highlight Color</label>
                <input class="color-picker" type="color" id="highlightColor" data-setting="highlightColor">
            </div>
        </div>
        <div class="row py-2">
            <div class="col-auto">
        ...
        <div class="row justify-content-end pt-4">
            <div class="col-auto">
                ...
                <button type="button" class="btn btn-secondary" onclick="document.getElementById('logicDiffInput').click();"  data-bs-toggle="tooltip" data-bs-title="Import Logic Diff" data-bs-trigger="hover"><img src="/images/download.svg"></button>
            </div>
            <div class="col">
            </div>
            <div class="col-auto">
